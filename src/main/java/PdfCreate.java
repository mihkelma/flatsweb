...
public class PdfCreate {
    ...
    public static void createPDF (Invoice invoice, Integer number) throws IOException {
        PDDocument document = new PDDocument();
        PDPage page = new PDPage(PDRectangle.A4);
        document.addPage(page);
        File fontBolFile = new File(PdfCreate.class.getResource("lato-bold.ttf").getFile());
        File fontRegFile = new File(PdfCreate.class.getResource("lato-light.ttf").getFile());
        PDTrueTypeFont fontBold = PDTrueTypeFont.load(document,fontBolFile,Encoding.getInstance(COSName.WIN_ANSI_ENCODING));
        ...
        String fileName = "arve_" + dateFormat2.format(c.getTime());
        System.out.println("Failinimi: "+fileName);
        ...
        //table sum part
        lastX += 300;
        if(!invoice.getVat().equals(new BigDecimal(0))) {
